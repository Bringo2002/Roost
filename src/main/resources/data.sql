...
INSERT INTO properties (title, location, price, bedrooms, type, available, landlord_phone, description, image_url, verified, holding_fee_paid, latitude, longitude)
...
SELECT 'Spacious 3BR Family Home', 'Karen, Nairobi', 120000, 3, 'rental', true, '+254723456789',
       ...
       'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80', true, false, -1.3187, 36.7117
...
SELECT 'Luxury Penthouse', 'Kilimani, Nairobi', 250000, 4, 'rental', true, '+254734567890',
       ...
       'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=800&q=80', false, false, -1.2889, 36.7863
...
SELECT 'Cozy Bedsitter', 'Roysambu, Nairobi', 12000, 1, 'rental', true, '+254745678901',
       ...
       'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=800&q=80', true, false, -1.2181, 36.8876
...
SELECT '4BR Villa for Sale', 'Runda, Nairobi', 45000000, 4, 'sale', true, '+254756789012',
       ...
       'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=800&q=80', true, false, -1.2216, 36.8032
...
SELECT 'Stylish Airbnb Loft', 'Lavington, Nairobi', 8500, 2, 'airbnb', true, '+254767890123',
       ...
       'https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=800&q=80', true, false, -1.2827, 36.7686
...
SELECT '2BR Apartment Kileleshwa', 'Kileleshwa, Nairobi', 65000, 2, 'rental', false, '+254778901234',
       ...
       'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=800&q=80', true, true, -1.2785, 36.7777
...
SELECT '1BR Serviced Apartment', 'CBD, Nairobi', 5000, 1, 'airbnb', true, '+254789012345',
       ...
       'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=800&q=80', false, false, -1.2864, 36.8172
